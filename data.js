  ...
  diets: {
    cutting: {
      ...
      treino: {
        ...
        meals: [
          ...
          { name: 'Refeição 2', items: ['100g Arroz OU Macarrão', '150g Frango/Tilápia/Patinho (feito)', '60–80g Legumes', 'Salada à vontade'] },
          { name: 'Refeição 3', items: ['150g Frango/Tilápia/Patinho (feito)', '100g Legumes', '100g Morango', 'Salada à vontade'] },
          { name: 'Refeição 4 ou 5', items: ['200g Batata Inglesa (pesada crua)', '150g Frango/Tilápia/Patinho (feito)', '60–80g Legumes', 'Salada à vontade'] },
      ...
      descanso: {
        ...
        meals: [
          ...
          { name: 'Refeição 2', items: ['200g Batata Inglesa (pesada crua)', '170g Frango/Tilápia/Patinho (feito)', '60–80g Legumes', 'Salada à vontade'] },
          { name: 'Refeição 3', items: ['170g Frango/Tilápia/Patinho (feito)', '100g Legumes', '100g Morango', 'Salada à vontade'] },
          { name: 'Refeição 4 ou 5', items: ['150g Batata Inglesa (pesada crua)', '170g Frango/Tilápia/Patinho (feito)', '60–80g Legumes', 'Salada à vontade'] },
    ...
    estabilizacao: {
      ...
      all: {
        ...
        meals: [
          { name: 'Refeição 1', items: ['100g Mamão OU Abacaxi', '30g Aveia', '20g Whey', '1 Ovo + 1 Clara', '1 ft Pão de Forma OU 30g Tapioca', '20g Mussarela'] },
          { name: 'Refeição 2', items: ['100g Arroz OU Macarrão', '170g Frango/Tilápia/Patinho (feito)', '60–80g Legumes', 'Salada à vontade'] },
          { name: 'Refeição 3', items: ['170g Frango/Tilápia/Patinho (feito)', '100g Legumes', '100g Morango', 'Salada à vontade'] },
          { name: 'Refeição 4 ou 5', items: ['200g Batata Inglesa (pesada crua)', '170g Frango/Tilápia/Patinho (feito)', '60–80g Legumes', 'Salada à vontade'] },
          { name: 'Refeição 5 ou 4', items: ['100g Mamão OU Abacaxi', '30g Aveia', '30g Whey', '80g Maçã', '20g Pasta de Amendoim', '100ml Leite/Iogurte desnatado'] },
        ],
      },
      guidance: {
